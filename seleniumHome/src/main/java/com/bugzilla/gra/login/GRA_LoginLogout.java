...
public class GRA_LoginLogout {
	...
	public void fn_TopNavLogin(HashMap<String, String> m12){
		...
		System.out.println(LoginLogoutPage.weel_txt_LoginWelcome.getText());
//		System.out.println(LoginLogoutPage.weel_txt_LoginWelcome.getAttribute("text"));
//		System.out.println(LoginLogoutPage.weel_txt_LoginWelcome.contains(m12.get("UserName")) + " is validated-----");
