...
public class OR_TopNav {


	final public static String val_wl_newBug 			= "//li/a[text()='New']";
	final public static String val_wl_search 			= "//li/a[text()='Search']";
	final public static String val_txt_loginUserName 	= "//div[@id='welcome-admin']/p[0]";
